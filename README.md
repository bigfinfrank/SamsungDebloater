...
*Tested on a Snapdragon Samsung Galaxy Note 20 Ultra 5G VZW bought in the US running System Update 7 updated to System Update 8*
...
# To Do
- Finish docs
- Test removal of com.qualcomm.atfwd (WiFi screen mirroring service that seems to run 24/7 -_-)
- Make proper PowerShell and Bash scripts, instead of big txt files with commands
- Add names for each app to the script
- Update script for Note 20 Ultra System Update 8
- Investigate remaiming background processes
- Make an undo script, it's possible even with the uninstall adb command I use :)
