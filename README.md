...
- This script is designed to be run on a fresh factory reset before the internet has been connected and without a SIM card installed (you can insert your SIM afterwards and connect to the internet afterwards).
...
## Connecting with ADB
Now, open up your Terminal of choice- I prefer Windows so I'll be using the latest version of PowerShell through Windows Terminal but the process should be virtually identical on your system, if you run into trouble then [Google your issue](https://google.com) and if you're feeling generous make a PR with the solution you find or make a issue if Google wasn't helpful. 
